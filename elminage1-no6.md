...
（＊ウィザードアイとは、ウィザードリィ６に登場する魔法のひとつです。扉の向こうの状況を覗き見ることができます）

## 最後は僧侶ハナウリ

ハナウリさんは、たしか、街の施設紹介の時に、小ネタで登場して貰った方です。

殴り僧侶も悪くないと思いましたが、清楚さんにしました。

エルミナにおける僧侶は、まず最速で帰還魔法を使えます。

これはとても重要です。エルミナでは、最初の階層は、どれくらいの難易度か示されますが、下の階層は未知です。

基本的には、一段階強い敵がでまして、後衛を優先的に狙う狩人系の魔物が登場すると、全滅の危機です。

そんなときには、帰還魔法ですね。

にくいことに、この**帰還魔法は、一度使うと忘れてしまいます**。

これがなかなか緊張感のあるバランスを保っています。

しかし序盤の帰還手段は皆無なので、僧侶をいれると楽できるでしょう。

### さて、ハナウリさんは人間で

僧侶は魔法職ですが、盾も装備できて、盗賊より生命力があったりします。

僧侶の適正はドワーフですが、ドワーフの女性は、あのハナウリさんかというと、微妙でありますので、人間としました。

生命力はやはり高くしておきましょう。

たいていTRPGでは、最初のボーナスは体力に振るのが基本です。

![エルミナージュ１の冒険者登録。僧侶は善か悪がなれる。人間は標準的なステータス](https://raw.githubusercontent.com/hashsan/i/main/20240521_212304.jpg)

僧侶は善か悪がなれます。人間種族は、万能で器用貧乏なステータスです。

そういう意味もあってか、人間はあらゆるパラメータが必要な君主や忍者になりやすかったりします。

### ボーナスは２０までは必要ない

僧侶の転職条件は知恵１２です。

何回か押すと、１８がでたので１８で振ります。

![エルミナージュ１の冒険者登録。すでに君主相当のボーナスを持つ僧侶ハナウリ](https://raw.githubusercontent.com/hashsan/i/main/20240521_212830.jpg)

すでに君主転職相当のステータスを持つ僧侶ハナウリ。

ポイントは、信仰と体力と敏捷に振りました。

君主にしようか迷いましたが、帰還魔法の取得が遅れますので、君主相当のステータスですが僧侶です。

（＊君主は僧侶魔法を覚えますが、レベル４から覚え始め、その分だけ、全段階の魔法を覚えるレベルがあがります）

## これに加えて、戦士、狩人、司教の３人です

戦士はグレイス。初期からエルミナに入っているキャラクターで、開発リーダーの小宮山氏のアバター相当にあたります。

狩人はナナシ。このゲームプレイ日記の主人公的存在になります。

司教はgreen氏。こちらも最初からエルミナに入っているキャラクターで、エルミナやっている方は、いつもお世話になる無料鑑定さんです。今回は、リアルタイムで鑑定してもらいます。

## 次回は、この世界の種族についてから

だいたい５０００文字程度を目標に毎回書いています。

かなりお急ぎで書いたつもりが、やはり紙面を超えてしまいました。

種族の説明は次回に持ち越します。次は、王様まで行くよ。

種族は、ウィザードリィの原典からすると倍に増えているのです。そうして、なかなかにうまい具合の棲み分けとなっております。

やはり色があって、方向性がしっかりとあると、良作になるのかもしれませんね。

[第７話につづく](edit.html?file=elminage1-no7.md)