...
## ７３．便利な武具教えて
ナイトシールド。どこでも手に入る上に、その性能の良さに驚くだろう。AC－７。戦士でよかったと思える品。

## ７４．便利な武具教えて
錆び付いた指輪。どこでも手に手に入りますが呪われた品なので装備せずもっておきましょう。ヴァンパイアロードを召喚中にSPを開放すると、盟友の指輪に変化する。この盟友の指輪をさらにSP開放すると、魔導に転職できる。

## ７５．便利な道具教えて
紅茶葉。使用人しか使えませんが、いざという時にMPを回復できます。

## ７６．便利な道具教えて
麻痺消し薬。麻痺は僧侶が治せますが、その僧侶が麻痺にかかると大変ですので、ひとつは持っておきましょう。おそらくドロップ品で手に入ります。

## ７７．便利な道具教えて
解石薬。魔導が石化してしまっては転移魔法を唱えられなくなっていまいますので、ひとつは持っておきましょう。これもおそらくドロップ品で手に入ります。売ると高い。

## ７８．便利な道具教えて
骨のスリッパ。リセットプレイしてもよいですが、骨のスリッパがあると、全滅しても、死体が勝手に街に戻ります。合成アイテムです。

## ７９．便利な道具教えて
羊の毛筆。ルームガータをマップに表示できます。これがあるとアイテムギャザリングが捗ります。合成アイテム。

## ８０．便利な道具教えて
驚きラッパ。パーティーのACを４さげる。オートで使い続けると、長引く戦いで有利になります。最初から売っています。

## ８１．便利な道具教えて
地割れ大鼓。全体範囲攻撃の鳴り物。属性を強化すれば、さらに強くなる。ドロップは監獄あたりです。

## ８２．便利な道具教えて
ドヴェル軟鋼。錬金素材ですが、これを錬金鍛冶すると、ターン回復と状態異常付与がつけられます。

## ８３．便利な道具教えて
魔蒼石。こちらも錬金素材。これを錬金鍛冶すると、状態異常付与と、倍打をつけられます。練度が１５ある魔蒼石であれば、霊倍打をつけておきましょう。

## ８４．便利な道具教えて
天使の小窓。最初の王様の話をよく聞いていれば、これが便利なのはわかるでしょう。持っていると、ミニマップを表示できます。エルミナではシリーズを通してのお約束です。


## ８５．魔物を使役できるって聞いたけど
はい、エルミナは６人＋１枠制です。１枠にはNPCや召喚物を加えることができます。召喚は、召喚師だけではなく、ダイヤの指輪でも召喚魔法を取得可能です。
...
## ９２．序盤の金策教えて
序盤の金策は、まずフランベルジュを手に入れて、マウレアの森で、オート戦闘をすることでしょう。すると、穴あきローブが手に入りますので、それを売ると、５千ゴールドです。イノセント装備も、どこでも手に入るので、売ってお金にかえてもいいよ。

## ９３．ライバルパーティーって何？
ライバルパーティーは、主人公パーティーが勝利するたびに、不屈の精神で強くなる対抗馬です。正直３段階目になるとレベル１０程度では太刀打ちできません。

特に倒したところで、ご褒美があるわけでもありませんが、このエルミナを彩るようなお約束となっております。盗賊が装備を解除してぶんどるといいです。
